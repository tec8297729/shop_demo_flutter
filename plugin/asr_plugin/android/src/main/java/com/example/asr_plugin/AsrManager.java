package android.src.main.java.com.example.asr_plugin;

import android.content.Context;
import android.util.Log;

import android.src.main.com.baidu.speech.EventManager;
 ...
 * 语音管理类，开始录音、停止录音、重置录音几个方法
 */
public class AsrManager {
    private  static  final  String TAG = "AsrManager"; // 打log的标记
    /**
...
//    public void setRecogEventAdapter(IRecogListener recogListener) {
//        if (!isInited) {
//            throw new RuntimeException("release() was called");
//        }
